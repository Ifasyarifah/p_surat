...
class LaporansuratkeluarController extends Controller
{
    public function print($id)
    {
        ...
        $pdf = PDF::setOptions(['isHtml5ParserEnabled' => true, 'isRemoteEnabled' => true])->loadview('surat_keluar.print_view', compact('data','ki_logo','garuda_logo'));
    ...
    public function printView($id)
    {
        ...
        return view('surat_keluar.print_view', compact('data','ki_logo','garuda_logo'));
    }
}
