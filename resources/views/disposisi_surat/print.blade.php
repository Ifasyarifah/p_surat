<body>
    ...
    <img src="https://onklas.smk1sumenep.sch.id/pluginfile.php/1/core_admin/logocompact/300x300/1645200023/logo.png" style="height:140px;">
    </div>
    </div>
    <div class="row">
    <center>
    ...
    <tr>
    <td style="width:50%;">Asal Surat : <?php echo $d['asal_surat'];?></td><td style="width:50%;">Tanggal Diterima : <?php echo $d['tanggal_diterima'];?></td>
    </tr>
    <tr>
    <td style="width:50%;">Nomor Agenda : <?php echo $d['nomor_agenda'];?></td><td style="width:50%;">Tanggal Disposisi : <?php echo $d['tanggal_d'];?></td>
    </tr>
    <tr style="height:50px;">
