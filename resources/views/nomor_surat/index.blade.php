                    ...
                    <tbody>
                      @foreach($suratkeluars as $data)
                        <tr>
                          ...
                          <td>{{ $data->id }}</td>
                          <td>{{ $data->nomor_suratK }}</td>
                          <td>{{ $data->perihal_k }}</td>
                          ...
                          <td class="text-center">
                              <a href="{{ asset('storage/file/surat-keluar/'.$data->file)}}">File</a>
                          </td>
                          <td>{{$data->status}}</td>
                          <td class="text-center col-3">
                            <form action="{{ route('surat_keluar.destroy', [$data->id]) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
