                      ...
                      <div class="card-header">{{ __('Create Suratmasuk') }}</div>
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name_Suratmasuk" name="name_Suratmasuk" placeholder="Name Suratmasuk" class="form-control @error('name_Suratmasuk') is-invalid @enderror" value="{{ old('name_Suratmasuk') }}">
                                    @error('name_Suratmasuk')
